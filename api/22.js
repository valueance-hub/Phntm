...
const SYSTEM = [
  ...
  '',
  'EAST ASIA',
  '  Korea 영양정보 / 영양성분 / 칼로리 · 쿠팡 Coupang, 네이버쇼핑, 스마트스토어, 11번가, 지마켓,',
  '    마켓컬리, 올리브영, 다이어트신, 네이버 블로그, manufacturer site',
  ...
  'SMALL BRANDS — if the first search finds nothing, try again with different shapes before giving up:',
  '  the product name alone; brand only; brand + flavour; the name without the weight;',
  '  the romanised spelling and the native spelling; the name plus 칼로리, 성분, kcal, or nutrition facts.',
  '  Widen beyond shops to community and review sources — 네이버 블로그, 다이어트신, 스마트스토어,',
  '  11번가, 지마켓, fitness forums, Reddit, and Open Food Facts (which carries many small imports).',
  '  Small local brands are often only listed on one page, so a second or third query shape matters.',
  'If after several query shapes the product genuinely cannot be found, estimate from the closest',
  'comparable product in that category and mark it in the name as "(estimated — label not found)"',
  'so the person knows to correct it by hand.',
  '',
